...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-full bg-white text-gray-900 p-6 flex flex-col gap-6">
      {/* Header */}
      <div className="flex justify-between items-center border-b border-gray-200 pb-4 bg-white">
      ...
      <div className="space-y-6">
        ...
        {/* Quick Filter */}
        <section>
          <h3 className="font-medium mb-2 text-gray-700">Quick Filter</h3>
        ...
        {/* Offers */}
        <section>
          <h3 className="font-medium mb-2 text-gray-700">Offers</h3>
          <div className="flex flex-col gap-2">
        ...
        {/* Cuisines */}
        <section>
          <h3 className="font-medium mb-2 text-gray-700">Cuisines</h3>
          <input
            type="text"
            placeholder="Search cuisine"
            value={searchCuisine}
            onChange={(e) => setSearchCuisine(e.target.value)}
            className="w-full mb-2 p-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-400 focus:outline-none transition"
          />
          <div className="flex flex-col gap-2">
            {cuisines
              .filter((c) =>
